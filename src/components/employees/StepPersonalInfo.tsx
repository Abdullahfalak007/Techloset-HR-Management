...
//   // This effect sets up the Cloudinary widget once, and also
//   // listens for the "avatar-edit" event when editing.
//   useEffect(() => {
//     if (!window.cloudinary) return;
...
//     // only in edit mode do we wire up the overlay‐pencil
//     if (isEditing) {
//       const handleAvatarEdit = () => widget.open();
//       window.addEventListener("avatar-edit", handleAvatarEdit);
//       return () => {
//         window.removeEventListener("avatar-edit", handleAvatarEdit);
//       };
//     }
...
//   return (
//     <div className="space-y-6">
//       {/* Avatar upload area only when adding */}
//       {!isEditing && (
//         <div className="flex items-center space-x-4">
//           <div
  ...
  const openWidget = () => {
    ...
    const widget = window.cloudinary.createUploadWidget(
      ...
      (error: any, result: any) => {
        ...
        if (result.event === "success") {
          // update both the local preview and the parent form state

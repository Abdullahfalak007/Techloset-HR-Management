...
// src/components/employees/StepAccountAccess.tsx
"use client";
      ...
      <div className="grid grid-cols-2 gap-6">
        {Object.entries(data).map(([name, value]) => (
          <input
            ...
            value={value}
            onChange={handleChange}
            className="w-full bg-[var(--surface)] border border-[var(--border)] rounded px-4 py-3 placeholder-[var(--text-secondary)] text-[var(--text-primary)] focus:border-[var(--accent)] focus:ring-0"
          />
        ))}
      </div>

...
//     });
//     if (res.ok) {
//       router.refresh(); // ← this will re-render your layout, navbar, profile, etc.
//     } else {
...
//               if (
//                 res.info &&
//                 typeof res.info !== "string" &&
//                 res.info.secure_url
//               ) {
//                 setAvatarUrl(res.info.secure_url);
//               }
//             }}
//           >
//             <div className="absolute bottom-0 right-0 bg-orange-500 p-2 rounded-full shadow-lg hover:bg-orange-600 cursor-pointer">
//               {/* camera icon */}
//               <svg

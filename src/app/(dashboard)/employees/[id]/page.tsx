...
export default function ViewEmployeePage() {
  ...
  if (!employee) return <p className="p-6 text-gray-400">Loading...</p>;
    ...
    <div className="space-y-6 p-6">
      ...
      <div className="flex space-x-6">
        ...
        <nav className="w-1/4 bg-[#1A1A1A] rounded-lg p-4 space-y-2">
          <button className="w-full flex items-center px-4 py-2 bg-orange-500 rounded-lg text-white space-x-2">
            <Image src={assets.icons.user} alt="" width={16} height={16} />
            <span>Profile</span>
          </button>
          <button className="w-full flex items-center px-4 py-2 text-gray-300 rounded-lg hover:bg-[#111] transition space-x-2">
            <Image src={assets.icons.calendar} alt="" width={16} height={16} />
            <span>Attendance</span>
          </button>
          <button className="w-full flex items-center px-4 py-2 text-gray-300 rounded-lg hover:bg-[#111] transition space-x-2">
            <Image src={assets.icons.project} alt="" width={16} height={16} />
            <span>Projects</span>
          </button>
          <button className="w-full flex items-center px-4 py-2 text-gray-300 rounded-lg hover:bg-[#111] transition space-x-2">
            <Image src={assets.icons.leaves} alt="" width={16} height={16} />
            <span>Leave</span>
          </button>
        </nav>
          ...
          <ul className="flex border-b border-gray-700">
            {TABS.map((t) => (
              <li
                ...
                onClick={() => setTab(t.id)}
                className={`
                  cursor-pointer px-5 py-2 flex items-center space-x-2 select-none
                  ${
                    tab === t.id
